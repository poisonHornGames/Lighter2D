...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Lighter", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Lighter", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "5";
		app.meta["company"] = "";
		app.meta["file"] = "Lighter";
		app.meta["name"] = "Lighter2D";
		app.meta["packageName"] = "com.poisonhorn.lighter2D";
